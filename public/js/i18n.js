...
(function (root, factory) {
  ...
  const ROWS = {
    ...
    'tour.advanced.entry.kicker': ['進階互動教學 · 約 4 分鐘', 'Advanced interactive tour · about 4 minutes', '上級操作ツアー・約4分', '고급 대화형 둘러보기 · 약 4분', '进阶互动教学 · 约 4 分钟'],
    'tour.advanced.entry.title': ['修正歌詞同步，再把來源穩定接到 OBS', 'Fix lyrics timing, then connect the source reliably to OBS', '歌詞の同期を直し、OBSへ安定して接続', '가사 싱크를 맞추고 OBS에 안정적으로 연결하기', '修正歌词同步，再将来源稳定连接到 OBS'],
    'tour.advanced.entry.body': ['分成「歌詞來源與同步」和「OBS 連接」兩章；可以只學現在需要的部分。', 'Choose Lyrics Sources & Timing or OBS Connection, and learn only the chapter you need now.', '「歌詞ソースと同期」と「OBS接続」の2章から、今必要な方だけ学べます。', '‘가사 소스와 싱크’, ‘OBS 연결’ 두 장 중 지금 필요한 것만 배울 수 있습니다.', '分为“歌词来源与同步”和“OBS 连接”两章；可以只学习现在需要的部分。'],
