...
(function (root, factory) {
  ...
  const ROWS = {
    ...
    'system.obsLauncherTitle': ['拖到 OBS 直接建立來源（實驗性）', 'Drag into OBS to create the source (experimental)', 'OBS にドラッグしてソースを作成（実験的）', 'OBS로 드래그하여 소스 만들기（실험적）', '拖到 OBS 直接建立来源（实验性）'],
    ...
    'publicRequest.statusHint': [
      '開啟後，觀眾可從外網打開分享連結，搜尋你目前公開的歌單並送出點歌；請求會先進下方待核准清單，你按下「加入」才會真的排進播放清單。',
      '開啟後，觀眾可從外網打開分享連結，搜尋你目前公開的歌單並送出點歌；請求會先進下方待核准清單，你按下「加入」才會真的排進播放清單。',
      '開啟後，觀眾可從外網打開分享連結，搜尋你目前公開的歌單並送出點歌；請求會先進下方待核准清單，你按下「加入」才會真的排進播放清單。',
      '開啟後，觀眾可從外網打開分享連結，搜尋你目前公開的歌單並送出點歌；請求會先進下方待核准清單，你按下「加入」才會真的排進播放清單。',
      '开启后，观众可从外网打开分享链接，搜索你目前公开的歌单并送出点歌；请求会先进下方待核准清单，你按下“加入”才会真的排进播放清单。'
    ],
