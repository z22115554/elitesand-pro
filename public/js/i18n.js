...
(function (root, factory) {
  ...
  const ROWS = {
    ...
    // ─── 公開點歌頁（2026-09-14 新增；尚未翻譯到其他語言，暫沿用繁中文字）───
    'nav.publicRequest': ['公開點歌頁', '公開點歌頁', '公開點歌頁', '公開點歌頁', '公開點歌页'],
    'publicRequest.statusTitle': ['公開點歌頁', '公開點歌頁', '公開點歌頁', '公開點歌頁', '公開點歌页'],
    ...
    'publicRequest.statusUnconfigured': ['尚未啟用', '尚未啟用', '尚未啟用', '尚未啟用', '尚未启用'],
    'publicRequest.statusDisabled': ['已停用', 'Disabled', '無効', '비활성화됨', '已停用'],
    'publicRequest.statusConnected': ['已連線', '已連線', '已連線', '已連線', '已连线'],
    'publicRequest.statusConnecting': ['連線中…', 'Connecting...', '接続中...', '연결 중...', '连接中…'],
    'publicRequest.statusReconnecting': ['重新連線中…', '重新連線中…', '重新連線中…', '重新連線中…', '重新连线中…'],
    'publicRequest.statusReplaced': ['已由其他程式接手', 'Another app instance took over', '別のアプリが引き継ぎました', '다른 앱 인스턴스가 인계했습니다', '已由其他程序接手'],
    'publicRequest.shareLinkLabel': ['分享連結', '分享連結', '分享連結', '分享連結', '分享链接'],
    'publicRequest.copyLink': ['複製連結', '複製連結', '複製連結', '複製連結', '复制链接'],
    'publicRequest.catalogLabel': ['公開哪一份歌單', '公開哪一份歌單', '公開哪一份歌單', '公開哪一份歌單', '公开哪一份歌单'],
    'publicRequest.catalogNone': ['（尚未選擇）', '（尚未選擇）', '（尚未選擇）', '（尚未選擇）', '（尚未选择）'],
    ...
    'publicRequest.rotateLink': ['重新產生連結（舊連結立即失效）', '重新產生連結（舊連結立即失效）', '重新產生連結（舊連結立即失效）', '重新產生連結（舊連結立即失效）', '重新生成链接（旧链接立即失效）'],
    'publicRequest.pendingTitle': ['待核准點歌', '待核准點歌', '待核准點歌', '待核准點歌', '待核准点歌'],
    ...
    'publicRequest.pendingEmpty': ['目前沒有待核准的點歌', '目前沒有待核准的點歌', '目前沒有待核准的點歌', '目前沒有待核准的點歌', '目前没有待核准的点歌'],
    'publicRequest.requestedBy': ['{name} 點的', '{name} 點的', '{name} 點的', '{name} 點的', '{name} 点的'],
    'publicRequest.reject': ['拒絕', '拒絕', '拒絕', '拒絕', '拒绝'],
    'publicRequest.approveEnd': ['加入歌單尾端', '加入歌單尾端', '加入歌單尾端', '加入歌單尾端', '加入歌单尾端'],
    'publicRequest.approveNext': ['加入下一首', '加入下一首', '加入下一首', '加入下一首', '加入下一首'],
    'publicRequest.approveFailed': ['加入播放清單失敗', '加入播放清單失敗', '加入播放清單失敗', '加入播放清單失敗', '加入播放清单失败'],
    'publicRequest.approved': ['已加入播放清單', '已加入播放清單', '已加入播放清單', '已加入播放清單', '已加入播放清单'],
    'publicRequest.rejectFailed': ['拒絕失敗', '拒絕失敗', '拒絕失敗', '拒絕失敗', '拒绝失败'],
    'publicRequest.toggleFailed': ['切換公開點歌頁狀態失敗', '切換公開點歌頁狀態失敗', '切換公開點歌頁狀態失敗', '切換公開點歌頁狀態失敗', '切换公开点歌页状态失败'],
    'publicRequest.rotateFailed': ['重新產生連結失敗', '重新產生連結失敗', '重新產生連結失敗', '重新產生連結失敗', '重新生成链接失败'],
    'publicRequest.rotated': ['已產生新連結', '已產生新連結', '已產生新連結', '已產生新連結', '已生成新链接'],
    'publicRequest.linkCopied': ['已複製連結', '已複製連結', '已複製連結', '已複製連結', '已复制链接'],
    'publicRequest.catalogFailed': ['更新公開歌單失敗', '更新公開歌單失敗', '更新公開歌單失敗', '更新公開歌單失敗', '更新公开歌单失败'],
    'publicRequest.newRequest': ['收到新的點歌：{title}', '收到新的點歌：{title}', '收到新的點歌：{title}', '收到新的點歌：{title}', '收到新的点歌：{title}']
  };
