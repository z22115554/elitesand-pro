...
(function (root, factory) {
  ...
  const ROWS = {
    ...
    'jizura.motionKomaTitle': ['作畫感：每秒 12 張的頓挫（日系文字 PV 常用的 2 コマ打ち）', 'On twos: 12 drawings per second, the stepped feel common in Japanese lyric videos', '作画感：毎秒12枚のコマ打ち（文字PVでよく使われる2コマ打ち）', '작화 느낌: 초당 12장의 끊어지는 움직임(일본 가사 PV에서 흔한 2코마)', '作画感：每秒 12 张的顿挫（日系文字 PV 常用的 2 コマ打ち）'],
