...
window.AppShared = (function () {
  const dom = {
    ...
    youtubeModeLink: document.getElementById('youtube-mode-link'),
    youtubeModeSearch: document.getElementById('youtube-mode-search'),
    youtubeLinkPanel: document.getElementById('youtube-link-panel'),
    youtubeSearchPanel: document.getElementById('youtube-search-panel'),
    youtubeSearchQuery: document.getElementById('youtube-search-query'),
    youtubeSearchSubmit: document.getElementById('youtube-search-submit'),
    youtubeSearchStatus: document.getElementById('youtube-search-status'),
    youtubeSearchClear: document.getElementById('youtube-search-clear'),
    youtubeSearchResults: document.getElementById('youtube-search-results'),
    youtubeSearchMore: document.getElementById('youtube-search-more'),
    youtubeAutoSeparate: document.getElementById('youtube-auto-separate'),
